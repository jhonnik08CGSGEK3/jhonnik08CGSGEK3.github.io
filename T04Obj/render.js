...
import { createCowText } from "./bin/cow.js";
...
export function initGL() {
    ...
    allData.then((res) => {
        ...
        let prCow = prim();
        prCow = prCow.load(createCowText(), shaderProgram);
        ...
        const render = () => {
            ...
            prCow.draw((m.scale(vec3(20)).mulMatr(m.rotateX(rot)).mulMatr(m.rotateY(rot)).mulMatr(m.rotateZ(rot)).mulMatr(m.translate(vec3(-3, -3, 0)))), cam);
