...
export function initGL() {
    ...
    allData.then((res) => {
        ...
        let prHex = createHexahedron(m.translate(vec3(0, 10, 0)), shaderProgram);
        ...
        const render = () => {
            ...
            prTetra.draw((m.scale(vec3(7, 7, 7)).mulMatr(m.rotateY(rot))), cam);
            prHex.draw((m.scale(vec3(7, 7, 7)).mulMatr(m.translate(vec3(0, 10, 0)))), cam);
            prOcta.draw((m.scale(vec3(7, 7, 7)).mulMatr(m.rotateY(rot))), cam);
